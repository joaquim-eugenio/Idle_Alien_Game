...
import { COSTS, ALIEN } from '../../lib/constants';
...
function UpgradeButton({ label, icon, cost, level, energy, disabled, maxLabel, onClick }: UpgradeButtonProps) {
